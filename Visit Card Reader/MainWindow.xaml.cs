...
namespace Visit_Card_Reader
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            new DirectoryInfo(this.FolderPicturePath).GetFiles("*", new EnumerationOptions() { IgnoreInaccessible = true, RecurseSubdirectories = true }).ToList().ForEach(file =>
            {
        ...
        private void MenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            else if (sender == this.CreateCSV)
            {
                ...
                string firstLine = "Nom;Email;Phone;Web;Image";
                List<string> lines = this.CardList.Items.OfType<VisitCard>().ToList().ConvertAll(c => c.Name.Replace("\n", "").Replace(";", ",") + ";" + c.Email.Replace("\n", "").Replace(";", ",") + ";" + c.Phone.Replace("\n", "").Replace(";", ",") + ";" + c.Web.Replace("\n", "").Replace(";", ",") + ";" + c.File);
